...
it('does accept null values', function () {
...
it('can be explicitly set to descending', function () {
    expect($this->sort->desc())->toBeInstanceOf(Sort::class)
        ->getDirection()->toBe(Sort::Descending);
});

it('can be explicitly set to ascending', function () {
